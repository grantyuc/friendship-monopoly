...
export const BOARD_CELLS: BoardCell[] = [
  ...
  { id: 1,  type: 'yellow',  label: '通力合作' },
  { id: 2,  type: 'green',   label: '心情分享' },
  { id: 3,  type: 'red',     label: '情境表演' },
  { id: 4,  type: 'yellow',  label: '通力合作' },
  { id: 5,  type: 'chance',  label: '機會' },
  { id: 6,  type: 'green',   label: '心情分享' },
  { id: 7,  type: 'red',     label: '情境表演' },
  { id: 8,  type: 'yellow',  label: '通力合作' },
  { id: 9,  type: 'green',   label: '心情分享' },
  { id: 10, type: 'destiny', label: '命運' },
  { id: 11, type: 'red',     label: '情境表演' },
  { id: 12, type: 'yellow',  label: '通力合作' },
  { id: 13, type: 'green',   label: '心情分享' },
  { id: 14, type: 'red',     label: '情境表演' },
  { id: 15, type: 'chance',  label: '機會' },
  { id: 16, type: 'yellow',  label: '通力合作' },
  { id: 17, type: 'green',   label: '心情分享' },
  { id: 18, type: 'red',     label: '情境表演' },
  { id: 19, type: 'yellow',  label: '通力合作' },
  { id: 20, type: 'destiny', label: '命運' },
  { id: 21, type: 'green',   label: '心情分享' },
  { id: 22, type: 'red',     label: '情境表演' },
  { id: 23, type: 'yellow',  label: '通力合作' },
  { id: 24, type: 'green',   label: '心情分享' },
  { id: 25, type: 'chance',  label: '機會' },
  { id: 26, type: 'red',     label: '情境表演' },
  { id: 27, type: 'yellow',  label: '通力合作' },
  { id: 28, type: 'green',   label: '心情分享' },
  { id: 29, type: 'red',     label: '情境表演' },
  { id: 30, type: 'destiny', label: '命運' },
  { id: 31, type: 'yellow',  label: '通力合作' },
  { id: 32, type: 'green',   label: '心情分享' },
  { id: 33, type: 'red',     label: '情境表演' },
  { id: 34, type: 'yellow',  label: '通力合作' },
  { id: 35, type: 'chance',  label: '機會' },
  { id: 36, type: 'green',   label: '心情分享' },
  { id: 37, type: 'red',     label: '情境表演' },
  { id: 38, type: 'yellow',  label: '通力合作' },
  { id: 39, type: 'destiny', label: '命運' },
];

// ─── Card data: mutable so external JSON can override ───
// At runtime, loadExternalCards() fetches cards.json and replaces these arrays.
// Designers edit cards.json → refresh page → done, no rebuild needed.

export let yellowQuestions: YellowQuestion[] = [
  ...
  { id: 16, title: '合作金字塔',    players: '2人',   content: '兩人背對背，手肘相勾，坐在地上合作站起來，維持 5 秒不倒。', meaning: '體會「互相支撐」才能一起站穩的道理。' },
  { id: 17, title: '同步開合跳',    players: '2人',   content: '兩人手牽手，喊口令同步做 10 次開合跳，節奏必須一致。', meaning: '練習「配合節奏」，感受同步的默契。' },
  { id: 18, title: '影子遊戲',      players: '2人',   content: '一人當影子，在 30 秒內完全模仿另一人的所有動作。', meaning: '專注觀察對方，培養「同理心」的第一步。' },
  { id: 19, title: '袋鼠跳',        players: '2-3人', content: '雙腳併攏，像袋鼠一樣連續跳 10 下，不能中途停下來。', meaning: '鍛鍊「堅持到底」的毅力。' },
  { id: 20, title: '默契運球',      players: '2人',   content: '兩人背對背夾住一顆小球（或靠枕），在不掉下來的情況下繞題目格走一圈。', meaning: '學習在合作中「互相遷就力道與速度」。' },
  { id: 21, title: '同步喊水果',    players: '2人',   content: '出題者喊「一、二、三」，兩人同時喊出一樣的水果名稱。不同則重來，或罰學企鵝走 10 步。', meaning: '練習「心有靈犀」的默契感。' },
  { id: 22, title: '兩人三腳',      players: '2人',   content: '把兩人內側腳綁起來（或相扣），在原地轉 3 圈不跌倒。', meaning: '體會「步調一致」才能穩穩前進。' },
  { id: 23, title: '猜拳大挑戰',    players: '2人',   content: '與對手隊伍猜拳，連贏 3 把的隊伍獲勝（平手需繼續猜到有人連贏），贏的隊伍 +100 分。', meaning: '體驗「運氣」與「堅持不放棄」的趣味。' },
  { id: 24, title: '超級模仿秀',    players: '2人',   content: '一人模仿卡通人物（如皮卡丘、角落生物），另一人需在 30 秒內猜出是誰。', meaning: '用「創意表達」拉近彼此距離。' },
  { id: 25, title: '雙人仰臥起坐',  players: '2人',   content: '一人壓腳，另一人做 5 下仰臥起坐，之後交換角色。', meaning: '練習「互相幫忙」，體會支持的力量。' },
  { id: 26, title: '合作拼圖',      players: '2人',   content: '在 1 分鐘內，兩人用小積木共同拼出一個愛心或簡單圖形。', meaning: '練習在時間壓力下「分工合作」。' },
];

export let greenQuestions: GreenQuestion[] = [
  ...
  { id: 16, title: '超級開心',       shareContent: '分享最近一次讓你「高興到跳起來」的事。', comfortPractice: '聽完後練習說：「聽起來真的太棒了，我也為你感到高興！」' },
  { id: 17, title: '很難過',         shareContent: '說一件最近讓你「哭哭」或覺得「很傷心」的事。', comfortPractice: '聽完後練習說：「聽起來你真的很傷心，沒關係，哭出來也沒關係。」' },
  { id: 18, title: '生氣氣',         shareContent: '分享一次讓你覺得「火冒三丈」的事。', comfortPractice: '聽完後練習說：「這確實很令人氣憤，換做是我也會很生氣。」' },
  { id: 19, title: '好緊張',         shareContent: '談談什麼事情最容易讓你「感到緊張」或「肚子痛」，例如上台講話、考試。', comfortPractice: '聽完後練習說：「緊張很正常的，每個人都會，深呼吸就沒事了。」' },
  { id: 20, title: '有點失望',       shareContent: '說一件原本很期待，但後來「結果不如預期」的事。', comfortPractice: '聽完後練習說：「失望的感覺很不好受，但下次還有機會的。」' },
  { id: 21, title: '好感激',         shareContent: '分享最近一件讓你「很想跟誰說謝謝」的事。', comfortPractice: '聽完後練習說：「能有這樣的感謝心，你真的很棒！」' },
  { id: 22, title: '覺得孤單',       shareContent: '談談什麼時候你覺得「只有自己一個人」。', comfortPractice: '聽完後練習說：「孤單的時候很冷，但我現在就在這裡陪你。」' },
  { id: 23, title: '覺得驕傲',       shareContent: '分享一件你自己覺得「非常厲害」的事。', comfortPractice: '聽完後練習說：「你真的太厲害了，這件事確實值得驕傲！」' },
  { id: 24, title: '尷尬時刻',       shareContent: '說一個你覺得最「尷尬」或「出糗」的往事。', comfortPractice: '聽完後練習說：「哈哈，這真的有點尷尬，但這也是很特別的回憶呢。」' },
  { id: 25, title: '小小遺憾',       shareContent: '分享一件「沒做到」但「很想做」的事。', comfortPractice: '聽完後練習說：「沒關係，現在開始做還來得及！」' },
  { id: 26, title: '充滿希望',       shareContent: '分享你下學期或未來「一個想實現的心願」。', comfortPractice: '聽完後練習說：「這是一個很棒的心願，期待它實現的那天！」' },
];

export let redQuestions: RedQuestion[] = [
  ...
  { id: 16, title: '借東西不還',     players: '2人',   situation: '朋友借了你心愛的鉛筆盒，結果一直忘記還，你也找不到他。', task: '演出如何溫和但堅定地提醒朋友歸還物品，而不傷害感情。' },
  { id: 17, title: '排隊插隊',       players: '2-3人', situation: '在福利社排隊買東西，有人突然插到你前面。', task: '演出如何有禮貌地告訴對方「我排在你前面喔」，維護自己的權益。' },
  { id: 18, title: '玩遊戲輸了被取笑', players: '2-3人', situation: '玩大風吹輸了，朋友取笑你說是「輸家」。', task: '演出如何表達「被嘲笑讓我不舒服，請不要這樣說」。' },
  { id: 19, title: '被老師誤會',     players: '2人',   situation: '老師誤會你上課講話，但你其實是在教同學題目。', task: '演出如何在下課後冷靜地向老師說明事實，並由安慰者說：「被誤會真的很委屈，沒關係我懂。」' },
  { id: 20, title: '打掃不公平',     players: '2-3人', situation: '輪到你和同學一起打掃，但他一直躲在旁邊玩不幫忙。', task: '演出如何告訴同學「我們一起分工會更快完成」，而不是直接告狀。' },
  { id: 21, title: '朋友遲到',       players: '2人',   situation: '約好週末去公園玩，你準時到了，但朋友遲到了 20 分鐘。', task: '演出如何誠實表達等待的焦慮，同時也聽聽對方遲到的原因。' },
  { id: 22, title: '亂碰我的東西',   players: '2人',   situation: '回家發現妹妹把你的圖畫紙亂畫一通。', task: '演出如何向家人表達「這是我很重要的東西，請先問過我」。' },
  { id: 23, title: '零食風波',       players: '2-3人', situation: '你有一包很好吃的零食但不想分享，同學因此生氣了。', task: '演出如何表達「這是我自己的東西，我可以選擇分不分」，同時安撫對方情緒。' },
  { id: 24, title: '被起綽號',       players: '2-3人', situation: '同學給你起了一個你不喜歡的綽號，還一直叫。', task: '演出如何嚴肅地告訴對方「請叫我的名字，我不喜歡這個綽號」，並由安慰者說：「起綽號很討厭，你是獨一無二的，別理他。」' },
  { id: 25, title: '霸佔玩具',       players: '2-3人', situation: '有人一直霸佔你想玩的溜滑梯，怎麼等都不下來。', task: '演出如何溝通「我也想玩，我們可以輪流嗎？」而非直接推擠。' },
];

export let chanceCards: SpecialCard[] = [
...
export let destinyCards: SpecialCard[] = [
...
// Fetches cards.json at startup. If found, replaces all card arrays.
// If not found or invalid, silently keeps built-in defaults.
export async function loadExternalCards(): Promise<boolean> {
  try {
    const res = await fetch('./cards.json');
    if (!res.ok) return false;
    const data = await res.json();
    if (data.yellow?.length) yellowQuestions = data.yellow;
    if (data.red?.length) redQuestions = data.red;
    if (data.green?.length) greenQuestions = data.green;
    if (data.chance?.length) chanceCards = data.chance;
    if (data.destiny?.length) destinyCards = data.destiny;
    console.log('[友誼大富翁] 已從 cards.json 載入卡片資料');
    return true;
  } catch {
    console.log('[友誼大富翁] 未找到 cards.json，使用內建預設卡片');
    return false;
  }
}
